 ...
 // class EncryptVICData
    ...
    public static boolean DEBUG           = false;    // toggle debug prints
       ...
       /*---------------------------------------------------------------------
        ...
        |
        |  Note: A version of this file was provided by the instructors of
        |        CSC 345, and slight alterations were made by Jack Williams.
        *-------------------------------------------------------------------*/

    public static EncryptVICData readVICData (String pathName)
    {
        EncryptVICData vic = new EncryptVICData(); // Object to hold the VIC input data
